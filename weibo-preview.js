						...
						for ( var x = 0; x < emoji[ i ].sweibo.length; x++ ) {
							...
							if ( matches === emoji[ i ].sweibo[ x ] ) {
								...
								if ( emoji[ i ].sprite )
									...
									return '<i class="wp-emoji" style="background-image:url(' + emoji[ i ].url + ');">' + matches + '</i>';
